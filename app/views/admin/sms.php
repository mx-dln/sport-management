...
<div class="overflow-x-auto rounded-xl border border-slate-200 bg-white shadow-sm"><table class="w-full text-sm"><thead class="bg-slate-50"><tr><th class="table-th">Recipient</th><th class="table-th">Phone</th><th class="table-th">Message</th><th class="table-th">Status</th><th class="table-th">Sent At</th></tr></thead><tbody><?php foreach ($logs as $l): ?><tr><td class="table-td"><?= e($l['recipient_name']) ?></td><td class="table-td"><?= e($l['phone_number']) ?></td><td class="table-td"><?= e($l['message']) ?></td><td class="table-td"><?= e(ucwords(str_replace('_', ' ', (string)$l['status']))) ?></td><td class="table-td"><?= e(format_datetime_12($l['sent_at'] ?? '')) ?></td></tr><?php endforeach; ?></tbody></table></div>
